...
Expand-Archive -Path "C:\Installers\PSAppDeployToolkit.zip" -DestinationPath "C:\Installers\PADT\"
Copy-Item -Path "C:\Installers\PADT\Toolkit\AppDeployToolkit" -Destination "C:\Installers\SourceTree\AppDeployToolkit" -Recurse
Copy-Item -Path "C:\Installers\PADT\Toolkit\Files" -Destination "C:\Installers\SourceTree\Files"
...
Copy-Item "C:\Installers\SourcetreeEnterpriseSetup.msi" -Destination "C:\Installers\SourceTree\Files\"
